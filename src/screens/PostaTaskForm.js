...
const PostaTaskForm = (props) => {
  ...
  useEffect(() => {
    if (props.route.params.s_id) {
      ...
      if (props.route.params.s_id === 2) {
        setServiceTitle('Errands');
      }
      if (props.route.params.s_id === 3) {
        setServiceTitle('Other Jobs');
      }
      if (props.route.params.s_id === 4) {
        setServiceTitle('Laundry');
      }
      if (props.route.params.s_id === 5) {
        setServiceTitle('Nanny');
      }
      if (props.route.params.s_id === 6) {
        setServiceTitle('Driver');
      }
      if (props.route.params.s_id === 7) {
        setServiceTitle('Child Care');
      }
      if (props.route.params.s_id === 8) {
        setServiceTitle('Chef/Butler');
      }
      if (props.route.params.s_id === 9) {
        setServiceTitle('Security');
      }
      if (props.route.params.s_id === 10) {
