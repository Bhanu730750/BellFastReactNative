...
import { errandspricing } from '../../pricing/ErrandsPricing';
...
const Errands = (props) => {
  ...
  const [dropoffLocationError, setDropoffLocationError] = useState(null);
  ...
  const onRequestSubmit = () => {
    ...
    if (
      ...
      dataArr.pickup = pickupLocation;
      dataArr.dropoff = dropoffLocation;

      props.navigation.navigate('ErrandsSummary', {postdata: dataArr});
    } else {
      description === ''
      ...
      pickupLocation === '' ? setPickupLocationError('Please enter pickup location.') : null;
      dropoffLocation === '' ? setDropoffLocationError('Please enter dropoff location.') : null;
      durationPicker === 0
        ...
        <View style={{padding: 15}}>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text style={{marginLeft: 10}}>Pickup Date</Text>
            </TouchableOpacity>
            <Subheading
              style={{
                fontFamily: 'Poppins-Medium',
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text style={{marginLeft: 10}}>Pickup Time</Text>
            </TouchableOpacity>
            <Subheading
              style={{
                fontFamily: 'Poppins-Medium',
