      ...
      <View
        ...
        <View style={{padding: 15}}>
          ...
          <View
              ...
              <Subheading style={{marginLeft: 20}}>
              {props.route.params.postdata.duration} Hrs
              </Subheading>
            </View>
          <Divider style={localStyles.divider} />
          ...
          <Divider style={localStyles.divider} />
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <Subheading>Meeting Time</Subheading>
            <Subheading style={{marginLeft: 20}}>
              {' '}
          ...
          <Divider style={localStyles.divider} />
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <Subheading>Sub Total</Subheading>
            <Subheading style={{marginLeft: 20}}>
            {new Intl.NumberFormat('ng-NG', { style: 'currency', currency: 'NGN' }).format(props.route.params.postdata.apartmenttype.price * props.route.params.postdata.duration)}
            </Subheading>
          </View>
          <Divider style={localStyles.divider} />
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            ...
            <Subheading
              ...
              {new Intl.NumberFormat('ng-NG', { style: 'currency', currency: 'NGN' }).format((props.route.params.postdata.apartmenttype.price * props.route.params.postdata.duration)+props.route.params.postdata.apartmenttype.adm_ch)}
            </Subheading>
          </View>
        </View>
      </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(OtherJobsSummary);
