      ...
      <View
        ...
        <View style={{padding: 15}}>
          ...
          <View
              ...
              <Subheading>Apartment Type</Subheading>
...
export default connect(mapStateToProps, mapDispatchToProps)(HousekeepingSummary);
