...
import { otherjobspricing } from '../../pricing/OtherJobs';
...
const OtherJobs = (props) => {
  ...
  const onRequestSubmit = () => {
    ...
    if (
      ...
      props.navigation.navigate('OtherJobsSummary', {postdata: dataArr});
    } else {
      description === ''
        ...
        <View style={{padding: 15}}>
          ...
          <View
            ...
            <Picker
              ...
              {otherjobspricing.map((list, index) => (
                <Picker.Item
                value={list}
                label={list.type}
              />
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text style={{marginLeft: 10}}>Meeting Date</Text>
            </TouchableOpacity>
            <Subheading
              style={{
                fontFamily: 'Poppins-Medium',
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text style={{marginLeft: 10}}>Meeting Time</Text>
            </TouchableOpacity>
            <Subheading
              style={{
                fontFamily: 'Poppins-Medium',
